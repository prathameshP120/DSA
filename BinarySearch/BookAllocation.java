...
public class BookAllocation {
    ...
    public static int BrueteForce(ArrayList<Integer> arr, int n, int m) {
...
// Space Complexity:  O(1) as we are not using any extra space to solve this problem.
   ...
   public static int BS(ArrayList<Integer> arr,int n ,int m){
          //calculate the searchSpace 
          if(m>n){
             return -1;
          }
